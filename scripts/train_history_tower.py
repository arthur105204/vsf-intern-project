#!/usr/bin/env python3
"""Train the minimal history-aware two-tower retrieval model."""
...
def write_training_report(path: Path, summary: dict, history: list[float]) -> None:
    path.parent.mkdir(parents=True, exist_ok=True)
    with path.open("w", encoding="utf-8") as f:
        f.write("# Two-Tower History Query Training Summary\n\n")
...
def main():
    ...
    parser.add_argument("--out_dir", default="outputs/experiments/history_tower_dev")
